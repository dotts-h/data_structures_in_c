...
- Add
  - At the beginning
  - At the end
  - Before an element identified by name(key)
  - After an element identified by name(key)
- Delete
  - First
  - Last
  - An element identified by name and surname(key)
- Print
- Destroy
...
- Generate a list of lists starting from the one created via the main menu
- Each list node requires:
  - Name
  - Address of first element of the list
  - Address of second element of the list
- Required features:
